...
public class Lemonade {
    ...
    Em uma barraquinha de limonada, cada limonada custa 5 reais. Os clientes estão em fila para comprar,
    um de cada vez. Cada cliente comprará apenas uma limonada e pagará com uma nota de 5, 10 ou 20 reais.

    Você deve dar o troco correto para que o cliente seja cobrado apenas 5 reais.
    No entanto, no começo você não tem nenhuma nota para dar o troco.
    Você só poderá dar notas que conseguir com os clientes anteriores.

    Dado um vetor de inteiros de tamanho N, onde cada elemento nessa ordem
    é a nota que o i-ésimo consumidor pagará, imprima “Verdadeiro”,
    se você consegue dar o troco correto para todos os clientes, ou “Falso” caso contrário.
    ...
    Saída
    Imprima “Verdadeiro”,
    se for possível dar o troco correto para todos os clientes,
    ...
    Saída 1   : 5 5 5 10 20
    Verdadeiro
    Explicação: Dos primeiros três clientes, coletamos três notas de 5 reais.
    Do quarto cliente, coletamos 10 reais e damos de volta 5.
    Para o quinto cliente, damos uma nota de 10 e uma de 5.
